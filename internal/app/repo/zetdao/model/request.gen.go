...
type Request struct {
	...
	Mark        string     `gorm:"column:mark;type:varchar(64);not null;index:idx_mark_status,priority:1;comment:标识" json:"mark"`                   // 标识
	...
	ParseStatus int32      `gorm:"column:parse_status;type:tinyint;not null;index:idx_mark_status,priority:2;comment:请求内容解析状态" json:"parse_status"` // 请求内容解析状态
