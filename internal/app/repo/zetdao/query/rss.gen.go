...
func (r rssDo) Create(values ...*model.Rss) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rssDo) CreateInBatches(values []*model.Rss, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r rssDo) Save(values ...*model.Rss) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rssDo) First() (*model.Rss, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Rss), nil
	}
}

func (r rssDo) Take() (*model.Rss, error) {
...
func (r rssDo) Last() (*model.Rss, error) {
...
func (r rssDo) Find() ([]*model.Rss, error) {
	result, err := r.DO.Find()
	return result.([]*model.Rss), err
}

func (r rssDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Rss, err error) {
	buf := make([]*model.Rss, 0, batchSize)
...
func (r rssDo) FindInBatches(result *[]*model.Rss, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r rssDo) FirstOrInit() (*model.Rss, error) {
...
func (r rssDo) FirstOrCreate() (*model.Rss, error) {
...
func (r rssDo) FindByPage(offset int, limit int) (result []*model.Rss, count int64, err error) {
...
func (r rssDo) Delete(models ...*model.Rss) (result gen.ResultInfo, err error) {
