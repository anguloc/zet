...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.taskDo.UseModel(&zet_model.Task{})
...
func (t taskDo) Create(values ...*zet_model.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) CreateInBatches(values []*zet_model.Task, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t taskDo) Save(values ...*zet_model.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) First() (*zet_model.Task, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*zet_model.Task), nil
	}
}

func (t taskDo) Take() (*zet_model.Task, error) {
...
func (t taskDo) Last() (*zet_model.Task, error) {
...
func (t taskDo) Find() ([]*zet_model.Task, error) {
	result, err := t.DO.Find()
	return result.([]*zet_model.Task), err
}

func (t taskDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*zet_model.Task, err error) {
	buf := make([]*zet_model.Task, 0, batchSize)
...
func (t taskDo) FindInBatches(result *[]*zet_model.Task, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t taskDo) FirstOrInit() (*zet_model.Task, error) {
...
func (t taskDo) FirstOrCreate() (*zet_model.Task, error) {
...
func (t taskDo) FindByPage(offset int, limit int) (result []*zet_model.Task, count int64, err error) {
...
func (t taskDo) Delete(models ...*zet_model.Task) (result gen.ResultInfo, err error) {
